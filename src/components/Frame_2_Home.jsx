    ...
    <div className='w-screen bg-[#00796B] text-white'>
      <div className='px-10 md:px-20 lg:px-40 py-10 md:py-16 lg:py-20 flex flex-col justify-center items-center h-full w-screen gap-2'>
        <div 
          ...
          style={{ backgroundImage: `url(${BgTarjeta})` }}
        >
        ...
        <div className='flex justify-center w-full'>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 w-full'>
            {[ 
              { img: path, title: "Rutas preparadas", text: "Gran parte de nuestras rutas fueron ingeniadas por nuestros guías expertos para hacer de tu experiencia una inolvidable y además con su respectiva dificultad asignada." },
              { img: Signpost, title: "Tips de nuestros guías", text: "En nuestros apartados podrás encontrar información interesante sobre el senderismo y consejos importantes a la hora de adentrarte a una aventura en el Ávila." },
              { img: Tipi, title: "Reserva fácil", text: "Encuentra rutas que te interesen y tan solo con unos breves pasos podrás empezar tu nuevo viaje." },
              { img: FourUsers, title: "Comunidad activa", text: "Podrás participar en foros y actividades de retroalimentación donde conectarás con estudiantes al igual que tú, con sed de aventuras." }
            ].map((card, index) => (

    ...
    return (
        <div className="inline-flex flex-col items-start relative">
                ...
                <div className="flex flex-col items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
                    ...
                    <div className="flex items-center gap-1 relative self-stretch w-full flex-[0_0_auto]">
                        <div className="inline-flex items-center gap-1 relative flex-[0_0_auto]">
                            <img src="https://llpzcyzmcfvjivsnjqbk.supabase.co/storage/v1/object/public/imagenes//MapPin.svg" alt="MapPin" className="!relative !w-5 !h-5" color="#424242" />
                ...
                <div className="inline-flex flex-col items-start gap-[5px] relative flex-[0_0_auto]">
                    ...
                    <div className="relative w-[114px] h-4">
                        <div className="inline-flex items-start absolute top-0 left-0">
                            <img src="https://llpzcyzmcfvjivsnjqbk.supabase.co/storage/v1/object/public/imagenes//Star.svg" alt="Star" className="!relative !w-4 !h-4" />
                            <img src="https://llpzcyzmcfvjivsnjqbk.supabase.co/storage/v1/object/public/imagenes//Star.svg" alt="Star" className="!relative !w-4 !h-4" />
                            <img src="https://llpzcyzmcfvjivsnjqbk.supabase.co/storage/v1/object/public/imagenes//Star.svg" alt="Star" className="!relative !w-4 !h-4" />
                            <img src="https://llpzcyzmcfvjivsnjqbk.supabase.co/storage/v1/object/public/imagenes//Star.svg" alt="Star" className="!relative !w-4 !h-4" />
                            <img src="https://llpzcyzmcfvjivsnjqbk.supabase.co/storage/v1/object/public/imagenes//Star.svg" alt="Star" className="!relative !w-4 !h-4" />
            ...
            <div className="inline-flex items-center gap-5 p-2.5 absolute top-5 left-12 bg-neutral-100 rounded-[0px_0px_10px_10px] backdrop-blur-[50px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(50px)_brightness(100%)]">
                <div className="inline-flex items-center gap-1 relative flex-[0_0_auto]">
                    <img src="https://llpzcyzmcfvjivsnjqbk.supabase.co/storage/v1/object/public/imagenes//Clock.svg" alt="Clock" className="!relative !w-4 !h-4" color="#757575" />
                ...
                <div className="inline-flex items-center gap-1 relative flex-[0_0_auto]">
                    <img src="https://llpzcyzmcfvjivsnjqbk.supabase.co/storage/v1/object/public/imagenes//PersonSimpleHike.svg" alt="PersonSimpleHike" className="!relative !w-4 !h-4" />
                    <div className="relative w-fit mt-[-1.00px] font-text-md-semibold font-[number:var(--text-md-semibold-font-weight)] text-[#757575] text-[length:var(--text-md-semibold-font-size)] tracking-[var(--text-md-semibold-letter-spacing)] leading-[var(--text-md-semibold-line-height)] whitespace-nowrap [font-style:var(--text-md-semibold-font-style)]">
                        Difucultad
                    </div>
                </div>
                ...
                <div className="inline-flex items-center gap-1 relative flex-[0_0_auto]">
                    <img src="https://llpzcyzmcfvjivsnjqbk.supabase.co/storage/v1/object/public/imagenes//Path.svg" alt="Path" className="!relative !w-4 !h-4" color="#757575" />
                    <div className="relative w-fit mt-[-1.00px] font-text-md-semibold font-[number:var(--text-md-semibold-font-weight)] text-[#757575] text-[length:var(--text-md-semibold-font-size)] tracking-[var(--text-md-semibold-letter-spacing)] leading-[var(--text-md-semibold-line-height)] whitespace-nowrap [font-style:var(--text-md-semibold-font-style)]">
                        Distancia
                    </div>
                </div>

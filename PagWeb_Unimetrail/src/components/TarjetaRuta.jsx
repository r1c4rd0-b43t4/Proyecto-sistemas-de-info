...
export function TarjetaRuta() {
    return (
        <article className="relative w-auto max-w-sm p-4 bg-white shadow-lg rounded-lg">
            <div className="relative w-full flex flex-col items-center">
                <div className="relative w-full flex justify-center">
                    <header className="absolute top-0 w-full flex justify-center mt-4">
                        <DatosRuta tiempo={2} distancia={3} dificultad={"jodido"} />
                    </header>
                    <svg
                ...
                <div className="w-full mt-4 flex flex-col items-left">
                    <h1 className="text-2xl font-bold">Título del SVG</h1>
                ...
                <div className="absolute bottom-4 right-4">
                    <button className="bg-[#00796B] text-white px-4 py-2 rounded-lg shadow-md hover:bg-[#005f56]">
                        Reservar
                    </button>
                </div>
            </div>
